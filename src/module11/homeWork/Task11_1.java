...
public class Task11_1 {
    public static void main(String[] args) {
        ...
        String fileToString = fileToString(fileWriter(replacer));
        System.out.println(fileToString);
        System.out.println("============File after append something============");
        File file = fileAppendString(fileWriter(replacer), "Add new string");
    ...
    public static File fileWriter(String str) {
